                ...
                <div class="row d-flex align-items-center ">
                    ...
                    <div class="col-md-8 isi-form text-left">
                        ...
                        <div class="form-group rincian-form">
                            ...
                            <input type="fullname" class="form-control" id="namalengkap" placeholder="Your Full Name Here..." required />
                        </div>
                        <div class="form-group rincian-form">
                            <label for="alamatemail" class="required">Email Address</label>
                            <input type="email" class="form-control" id="emailbaru" aria-describedby="emailHelp" placeholder="example@domail.com" required />
                        </div>
                        <div class="form-group rincian-form">
                            <label for="telepon" class="required">Phone Number</label>
                            <input type="text" class="form-control" id="phonenumber" aria-describedby="nomorbaru" placeholder="08573890xxxxx" required />
                        </div>
                        <div class="form-group rincian-form">
